...
const fitted: Record<TerminalId, EffectorTerminalDefinition> = {
  ...
  mace: maceDefinition({ ...TERMINAL_MACE, mass: 1.8, limits: { ...TERMINAL_MACE.limits, rollMax: null, bendMax: 1.25 } }),
  maul: maulDefinition({ ...TERMINAL_MAUL, mass: 4.5, trailingGripOffsetM: 0.12, limits: { ...TERMINAL_MAUL.limits, rollMax: 2.7, bendMax: 1.25 } }),
  plate: plateDefinition({ ...TERMINAL_PLATE, mass: 3.5, outboardOffset: 0.08, limits: { ...TERMINAL_PLATE.limits, rollMax: null, bendMax: 1.25 } }),
  whip: whipDefinition({ ...TERMINAL_WHIP, segmentMass: 0.08 }),
};
