...
**Status:** current
**Canonical source:** The current normative replay contract is [Hashes and replay integrity](../reference/hashes.md); implementation lives in [`Replay`](../../crates/sim/src/replay.rs#L61).
...
- Current single-limb command: [`Command`](../../crates/sim/src/command.rs#L545)
