...
**Status:** current
**Canonical source:** [`World`](../../crates/sim/src/world.rs#L43), deterministic geometry in [`fx`](../../crates/fx/src/geom.rs#L92), and the dependency manifests under [`crates/`](../../crates/)
...
[`impact_is_the_blade_plus_the_closing_and_backing_off_helps`](../../crates/sim/src/world.rs#L6306).
...
- Explicit world columns and generational storage: [`World`](../../crates/sim/src/world.rs#L43)
- Pairwise body separation: [`World::separate`](../../crates/sim/src/world.rs#L1104)
- Static closest-approach predicate: [`segment_circle`](../../crates/fx/src/geom.rs#L122)
- Bounded temporal sweep: [`swept_segment_circle`](../../crates/fx/src/geom.rs#L176)
- Current clamp rationale: [`agility_multiplier`](../../crates/sim/src/rules.rs#L238)
- Exhaustive historical-bound cost guard: [`no_blade_can_outrun_the_smallest_body`](../../crates/sim/src/entity.rs#L319)
- Current blade/body sweep: [`World::resolve_swings`](../../crates/sim/src/world.rs#L1292)
- Impact magnitude/projection composition: [`World::impact_speed`](../../crates/sim/src/world.rs#L2873)
