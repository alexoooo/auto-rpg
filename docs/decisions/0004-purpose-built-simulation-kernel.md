...
**Status:** current
**Canonical source:** [`World`](../../crates/sim/src/world.rs#L85), deterministic geometry in [`fx`](../../crates/fx/src/geom.rs#L92), and the dependency manifests under [`crates/`](../../crates/)
...
[`impact_is_the_blade_plus_the_closing_and_backing_off_helps`](../../crates/sim/src/world.rs#L12576).
...
- Explicit world columns and generational storage: [`World`](../../crates/sim/src/world.rs#L85)
- Pairwise body separation: [`World::separate`](../../crates/sim/src/world.rs#L2575)
...
- Current blade/body sweep: [`World::resolve_swings`](../../crates/sim/src/world.rs#L2763)
- Impact magnitude/projection composition: [`World::impact_speed`](../../crates/sim/src/world.rs#L5438)
