...
**Status:** current
**Canonical source:** [`World` combat phases](../../crates/sim/src/world.rs#L2302), [`Hand`](../../crates/sim/src/hand.rs#L181), and [`rules`](../../crates/sim/src/rules.rs#L1)
...
world tests near [`a_club_can_be_answered_by_swapping_to_a_guard`](../../crates/sim/src/world.rs#L15953)
...
- Tick ordering and combat resolution: [`world.rs`](../../crates/sim/src/world.rs#L2302)
...
- Termination outcome: [`World::timeout`](../../crates/sim/src/world.rs#L3980)
