...
- Portal opening and arming: [`Sim::open_the_way_out`](../../crates/web/src/lib.rs#L2745)
- Descent and hero persistence: [`Sim::descend`](../../crates/web/src/lib.rs#L2815)
- Browser tick integration: [`Sim::advance`](../../crates/web/src/lib.rs#L3074)
