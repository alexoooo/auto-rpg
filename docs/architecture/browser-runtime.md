...
- Fixed publication pools: [`thread_local!`](../../crates/web/src/lib.rs#L915)
- Packed frame writer: [`Sim::write_frame`](../../crates/web/src/lib.rs#L3187)
- Hand-written wasm exports: [`init`](../../crates/web/src/lib.rs#L3930)
