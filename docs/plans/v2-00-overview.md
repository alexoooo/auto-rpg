...
| [Smart articulated combat](smart-ai-00-overview.md) | Smart132 found the frozen pair's first swept-AABB difference at the A-side ordinal-0 segment-hilt start-point X operand; [Smart133](smart-ai-133-ordinal-31-tick-46-segment-hilt-start-x.md) is active | trace only that one point-construction operand; do not infer causality, change mechanics, widen, tune or open held-out work | no registered pin moves; generalized competence and `v2-18` remain blocked |
