...
| [Smart articulated combat](smart-ai-00-overview.md) | [Smart130](smart-ai-130-ordinal-31-arm-asymmetry.md) is active for the earliest frozen mismatch, ordinal 31 | preserve each arm's original terminal and name the first common-prefix solver-delta difference or earlier terminal; do not tune or open held-out work | no registered pin moves; generalized competence and `v2-18` remain blocked |
