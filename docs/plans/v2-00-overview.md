...
| [Smart articulated combat](smart-ai-00-overview.md) | Smart130 completed ordinal 31 at first effort/state/solver differences `36/37/46`; [Smart131](smart-ai-131-ordinal-31-tick-46-scan-budget.md) is active for the frozen tick-46 segment/body pair | name the first bounded region/visit transcript difference behind reference `budget` and held's absent rejected-pair diagnostic; do not widen, tune or open held-out work | no registered pin moves; generalized competence and `v2-18` remain blocked |
