...
| [Smart articulated combat](smart-ai-00-overview.md) | Smart131 found the frozen tick-46 path first differs at pair AABB control (`2` reference regions versus held `0`); [Smart132](smart-ai-132-ordinal-31-tick-46-pair-aabb-control.md) is active | name the first swept-AABB operand or axis-control difference for that one pair; do not infer causality, widen, tune or open held-out work | no registered pin moves; generalized competence and `v2-18` remain blocked |
