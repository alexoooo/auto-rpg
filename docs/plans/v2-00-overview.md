...
| [Smart articulated combat](smart-ai-00-overview.md) | exact feature mechanics and authority are complete; matched stationary calibration stopped at 688/900 structural failures | [Smart129 frozen shared-solver diagnosis](smart-ai-129-shared-solver-diagnosis.md); do not tune or open held-out work | no registered pin moves; generalized competence and `v2-18` remain blocked |
