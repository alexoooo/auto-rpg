...
| [Smart articulated combat](smart-ai-00-overview.md) | matched calibration stopped at 688/900; frozen controlled arms share the 198 solver-positive rows but differ in count on nine mirrored rows | plan earliest ordinal-31 arm-asymmetry provenance; do not tune or open held-out work | no registered pin moves; generalized competence and `v2-18` remain blocked |
