...
| [Smart articulated combat](smart-ai-00-overview.md) | exact feature mechanics and authority are complete; Smart128's serial calibration attempt timed out without an artifact | [Smart128 bounded collector and stationary matched calibration](smart-ai-128-matched-tactical-calibration.md) | no registered pin moves; generalized competence and `v2-18` remain blocked |
