...
| Distillation / DAgger | Multi-round query pipeline and 209 executed-reference imitation labels are available, with a constant-residual control. Independent student strength remains unproved. |
