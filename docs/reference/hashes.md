...
**Status:** current
**Canonical source:** [`World::state_hash`](../../crates/sim/src/world.rs#L4309), [`Scenario::fingerprint`](../../crates/sim/src/scenario.rs#L452), and pinned constants in tests.
...
|---|---:|---|---|
| `LAB_HASH` | `0xfe31370e141ef531` | [`crates/web/src/lib.rs`](../../crates/web/src/lib.rs#L10885) and [`tools/wasm_check.js`](../../tools/wasm_check.js#L37) | Not re-pinnable. It names its scenario and policy; investigate a move. |
...
| `ROOM_HASH` | `0x98441a18db7a95ca` | [`crates/web/src/lib.rs`](../../crates/web/src/lib.rs#L10944) and [`tools/wasm_check.js`](../../tools/wasm_check.js#L44) | `cargo test -p web -- --ignored --nocapture print_the_golden_hashes` |
| `BATTLE_HASH` | `0x9aafe4bd54560586` | [`crates/web/src/lib.rs`](../../crates/web/src/lib.rs#L10950) and [`tools/wasm_check.js`](../../tools/wasm_check.js#L50) | Same browser-golden command; update both owners. |
| `SWAP_HASH` | `0xf948f5486ee90191` | [`crates/web/src/lib.rs`](../../crates/web/src/lib.rs#L10966) and [`tools/wasm_check.js`](../../tools/wasm_check.js#L61) | Same browser-golden command; update both owners. |
| `BOW_HASH` | `0x4a1157735d305e9f` | [`crates/web/src/lib.rs`](../../crates/web/src/lib.rs#L10971) and [`tools/wasm_check.js`](../../tools/wasm_check.js#L70) | Same browser-golden command; update both owners. |
...
- Live state stream: [`World::state_hash`](../../crates/sim/src/world.rs#L4309)
