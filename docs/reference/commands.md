...
**Status:** current
**Canonical source:** [`Command`](../../crates/sim/src/command.rs#L544) and the adjacent input enums in the same module.
...
- Faction orders and encoding: [`Order`](../../crates/sim/src/command.rs#L666)
- Routing objectives: [`Objective`](../../crates/sim/src/command.rs#L773)
