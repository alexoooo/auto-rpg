...
- [learned Tactical V2 roster policy promotion, 2026-08-20](learned-roster-policy.md)
...
| learned Tactical V2 roster | promoted checkpoint passed every five-opponent row | [held-out roster](learned-roster-policy.md#held-out-roster) | pass; weakest row 69.25% wins with Wilson lower 64.6%, all safety/force/refusal/replay gates passed |
