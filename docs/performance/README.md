...
| smart articulated combat | controlled Robust Strike is visibly verified; generalized Tactical remains `21/100` strict and `55/100` outcome-only, and Smart125's `49/100` recertification was reverted | [tactical-policy outcome](smart-ai-tactical-policy.md) | rerun matched ordinary Tactical evidence next; no training, default promotion or `ARTICULATED_HASH` |
