...
| articulated contact successor | exact trajectory/lifecycle and lifted-Coulomb solver are retained behind the disabled feature; both native/wasm digests are registered | [contact research record](v2-articulated-contact-research.md#registered-exact-mechanics-receipts) | Smart124 authority prose remains; no default promotion, `ARTICULATED_HASH`, or existing-pin move |
