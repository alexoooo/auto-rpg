...
**Status:** current
**Canonical source:** this record, [`crates/lab/src/main.rs`](../../crates/lab/src/main.rs#L1954), and the `EMBODIED_CORPUS_DIGEST` row in the [golden registry](../reference/hashes.md#golden-registry)
...
`y = 8` that [`lab articulated`](../../crates/lab/src/main.rs#L1954) has always run for
...
[`crates/lab/src/main.rs`](../../crates/lab/src/main.rs#L1730) and asserted by
...
embodied one too — at
[`crates/lab/src/main.rs`](../../crates/lab/src/main.rs#L249). 200 seeds of
...
[`crates/lab/src/main.rs`](../../crates/lab/src/main.rs#L2139). The subject is
...
[`script_digest`](../../crates/policy/src/articulated_script.rs#L1073) skips every
