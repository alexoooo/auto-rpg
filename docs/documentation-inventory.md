...
| [`AGENTS.md#the-frame-abi-is-a-handshake-across-four-files`](../AGENTS.md#the-frame-abi-is-a-handshake-across-four-files) | The frame ABI is a handshake across four files | reference | current | v2-05 | none | Required four-part workflow remains here and links reference for exact layout, versions, identity, and append-only rules; v2-16 left the legacy frame ABI untouched and gave the pose/event streams their own reference authority beside it. |
