...
pub use rules::{
    ...
    strike_ticks, Stats, Weapon, BLOCK_LEAK_BRACED, BLOCK_LEAK_SNAP, BLOCK_RECOVERY, BRACE_SPIN,
    BRACE_TICKS, CAPABILITY_JUDGEMENT, DIM_INTELLECT, DIM_PERCEPTION, DT, FOLLOW_THROUGH,
    IMPACT_THRESHOLD, MAX_CONTACTS, RECOVERY_EXPOSURE, STRIKE_SLACK, STRIKE_SPENT_ARC,
    STRIKE_TIMEOUT, TICKS_PER_SECOND, WHIFF_RECOVERY, WINDUP_ARC,
};
