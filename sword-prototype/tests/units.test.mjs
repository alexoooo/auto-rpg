...
test("the_golem_is_assembled_rather_than_equipped_and_answers_to_its_own_surface", () => {
  ...
  // baseline.
  assert.deepEqual([...(golem.compatiblePolicies ?? [])], ["idle", "golem-duelist", "golem-fencer", "golem-planner", "golem-champion", "golem-neural", "golem-form", "golem-skirmisher", "golem-guardian", "golem-brawler", "golem-tactician", "golem-selector"]);
