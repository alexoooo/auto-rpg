...
test("the picker offers exactly the policies that exist", () => {
  assert.deepEqual(
    ...
    ["idle", "swinger", "duelist", "archer", "crawler", "golem-duelist", "golem-fencer", "golem-planner", "golem-champion", "golem-neural", "golem-form", "golem-skirmisher", "golem-guardian", "golem-brawler", "golem-tactician", "golem-learner", "golem-driver", "golem-selector"],
  );
