...
- `docs/plans/golem-00-overview.md`
- `docs/plans/golem-01-demolition.md`
- `docs/plans/golem-02-effector-bench.md`
- `docs/plans/golem-03-unique-pose-arms.md`
- `docs/plans/golem-04-terminals.md`
- `docs/plans/golem-05-locomotion-bench-and-biped.md`
- `docs/plans/golem-06-wheel-and-multileg.md`
- `docs/plans/golem-07-torso-and-head.md`
- `docs/plans/golem-08-assembly-and-arena.md`
- `docs/plans/golem-09-central-mind.md`
- `docs/plans/golem-10-body-parts-as-loot.md`
- `docs/plans/golem-11-playtest-record-and-close.md`
- `docs/plans/learn-00-overview.md`
- `docs/plans/learn-01-viable-matchups.md`
- `docs/plans/learn-02-curve-page.md`
- `docs/plans/learn-03-watch-a-snapshot.md`
- `docs/plans/learn-04-sweep-runner.md`
- `docs/plans/learn-05-sharded-fit.md`
- `docs/plans/learn-06-reward-shaping.md`
- `docs/plans/learn-07-action-surface.md`
- `docs/plans/learn-08-curriculum.md`
- `docs/plans/learn-09-network-and-algorithm.md`
- `docs/plans/learn-10-league-v2.md`
- `docs/plans/learn-11-long-run.md`
- `docs/plans/learn-12-close.md`
- `docs/plans/matchup-00-overview.md`
- `docs/plans/matchup-01-impulse-ram-fist.md`
- `docs/plans/matchup-02-mace-maul-whip.md`
- `docs/plans/matchup-03-matchup-screen.md`
- `docs/plans/matchup-04-tournament.md`
- `docs/plans/matchup-05-tactics-v2.md`
- `docs/plans/matchup-06-planner.md`
...
- `docs/plans/style-03-energy-scoring.md`
- `docs/plans/style-03-executor-and-form.md`
- `docs/plans/style-04-executor-and-form.md`
- `docs/plans/style-04-skirmisher.md`
- `docs/plans/style-05-guardian.md`
- `docs/plans/style-05-skirmisher.md`
- `docs/plans/style-06-brawler.md`
- `docs/plans/style-06-guardian.md`
- `docs/plans/style-07-brawler.md`
- `docs/plans/style-07-league-and-decision-log.md`
- `docs/plans/style-08-league-and-decision-log.md`
- `docs/plans/style-08-selector-and-tactician.md`
- `docs/plans/style-09-learner.md`
- `docs/plans/style-09-selector-and-tactician.md`
- `docs/plans/style-10-learner.md`
- `docs/plans/style-10-overnight.md`
- `docs/plans/style-11-close.md`
- `docs/plans/style-11-decisive.md`
- `docs/plans/style-11-overnight.md`
- `docs/plans/style-12-close.md`
- `docs/plans/style-12-command-surface.md`
- `docs/plans/style-13-dense-reward-and-ppo.md`
- `docs/plans/style-14-league.md`
- `docs/plans/style-15-close.md`
