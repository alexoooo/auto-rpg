...
const review = resolve(root, ".review/v3/basemesh");
...
const result = spawnSync(executable, ["--background", "--factory-startup", "--python",
  resolve(root, "asset-src/v3/spike_basemesh.py"), "--",
  "--review", review, "--output", resolve(root, "public/assets/warrior-basemesh.glb"),
